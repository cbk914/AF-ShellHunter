...
class ShellFinder():
	def __init__(self, version):
		...
		self.group.add_argument('--file', '-f', action='store', dest='File',help='Phishings file', default=False)
		...
		self.parser.add_argument('--show-string', '-ss', action='store', dest='string', help='Do not show responses w/ this code', default=False)
